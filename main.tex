...
through contributions by individuals to work on astropy in their own personal
time, contributions from individuals or groups to work on \astropy as 
part of a research project, or contributions from institutes that allocate 
people to work on \astropy. 
A list of organizations that have contributed to \astropy
are listed in the Acknowledgements.  
Different models have been proposed for the support of astropy 
(ie. \cite{2016arXiv161003159M}), 
but a sustainable, community-based model has not yet been established.
...
which generally covers the direct costs incurred by the \astropy project
