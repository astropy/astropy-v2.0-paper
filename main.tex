...
Astronomy as a field has thus long supported the development of specialized
software tools for astronomical tasks, from software packages that enable
individualized scientific research to data reduction tools and pipelines that
enable collaborations and survey operations.
...
More recently, package managers such as Anaconda\url{https://anaconda.org/} have
streamlined the installation process for most packages, therefore significantly
reducing the barrier to entry for using many such libraries.
