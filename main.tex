...
projects provide code that are useful to the astronomical community and meet the
...
The \astropypkg core package's documentation contains narrative descriptions of
...
\begin{description}
    ...
    \item[Tutorials] The \astropy tutorials are step-by-step demonstrations of
        ...
        exercises for the users, and are generally geared towards pedagogical
        activities.
