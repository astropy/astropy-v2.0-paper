...
The \package{astropy.table} package provides wrappers to \package{numpy} structure arrays, which can contain heterogeneous data sets. The package was described in detail in \cite{astropy}. Tables now has the ability to work with other \astropypkg classes including \texttt{Quantity}, \texttt{Time}, and \texttt{SkyCoord}. In addition, operations can also be performed on Tables.
...
\inlinecomment{Adrian PW}{The new features below need filling in.}

\begin{description}
    \item[QTable] TODO...quantity tables
    \item[Mixin columns for time and coordinates] TODO...
\end{description}
