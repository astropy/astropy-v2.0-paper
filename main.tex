...
\citep{Lupton2004} describe an “optimal” algorithm for producing red-green-blue (RGB) composite images from three separate high-dynamic range arrays. The \package{visualization} package provides a convenience function to create such an image.  It also includes an associated set of classes to provide alternate scalings.
...
% Larry TODO:  include RGB image here
