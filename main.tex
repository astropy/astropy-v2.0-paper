...
\section*{Notes and guidelines (\textit{to be removed})}
...
\begin{itemize}
    ...
    \item Use \escapecmd{\sectionname} not Section, \escapecmd{\figname} not Figure, \escapecmd{\documentname} not Article
\end{itemize}
