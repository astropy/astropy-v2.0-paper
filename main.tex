...
This distribution shows that the \astropypkg core package has been developed by
a broad contributor base, with a core team of developers having added over 1000
commits to the repository, and a smooth distribution of contribution level down
to a single commit.
