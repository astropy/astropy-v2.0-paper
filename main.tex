...
We would like to thank the community that have contributed to \astropy, 
that have open issues and provided feedback, and have supported the 
project in a number of different ways.  
%insert significant contributors to astropy who hav decided not to 
%be co-authors
