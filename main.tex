...
\textbf{Key new features:}
\begin{itemize}
	\item TODO: Celestial coordinates, but now also local coordinates (via EarthLocation + Time)
    \item TODO: differential classes
    \item TODO: Proper motions, radial velocities
