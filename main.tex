...
\textbf{Key new features:}
\begin{itemize}
    \item In addition to representing celestial coordinates, \astropypkg\
    now supports specifying positions on the Earth in a number of different
    geocentric systems with the \texttt{EarthLocation} class.
    ...
    tested feature.
    \item TODO: JPL ephemerids % Who can write this? Erik?
\end{itemize}
