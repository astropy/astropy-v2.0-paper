...
The \texttt{astropy.coordinates} subpackage ...
...
start with short description of the astropy approach and features (JPL ephemerids, barycentric correction, proper motions, coordinate frames) then shows the tests.

In particular, we had a discussion on problems with the definition of some coordinate system on the mailing list. Getting that discussion in here gives us a refereed paper to point to when we need to push the IAU to fix that.
...
\bibliographystyle{aasjournal}
\bibliography{bibliography}
>>>>>>> 6371637d7b2b9ce24f024d344c7591a3ba7ccc1e
