...
Physical constants include CODATA2014 and CODATA2010 versions. Astronomical constants
are organized into IAU2015 and IAU2012 versions to roughly indicate their sources.
The CODATA2014 and IAU2015 versions are combined into the default ASTROPYCONST20
version. For astropy v1.3 and earlier, the ASTROPYCONST13 namespace is available;
however when using previous versions of the constants, \package{Constants} should be used
directly; \package{astropy.units} will be initialized to the ASTROPYCONST20 versions.

Astronomers using \package{Constants} should take particular note of the constants
provided for Earth, Jupiter and the Sun. Following IAU 2015 Resolution B3, nominal
values are now given for masses and radii. The nominal values will not change as
estimates of these proper
