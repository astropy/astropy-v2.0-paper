...
software. While the programming language provides support for array representation \& 
arithmetic \citep[\package{numpy};][]{numpy}, a wide variety of functions for scientific 
computing \citep[\package{scipy};][]{numpy}, publication-quality plotting 
\citep[\package{matplotlib};][]{matplotlib}, tens of thousands of other high quality and easy 
to use packages are available which can help with tasks that are not astronomy specific but 
might be performed in the course of astronomical research, for example, interfacing with 
...
most packages significantly reducing the barrier to entry for using many such libraries.
...
the development of the \astropypkg.  Development of the \astropypkg is supported
by individuals who work on \astropy project in their own personal
time, by individuals or groups to work on \astropy as
...
Different funding models have been proposed for support of \astropy in the future
...
(individual or institutes) through the NumFOCUS organization\footnote{NumFOCUS
is a 501(c)(3) nonprofit that supports and promotes world-class, innovative,
open source scientific computing.},
which, has so far, covered the direct costs incurred by the \astropy project.
