...
The \package{Constants} package provides useful physical constants as quantities.  The package was described in \cite{astropy}.  \package{Constants} now include their own version to track when their values are adjusted. 
