...
since version v0.2 (previously described in \citealt{astropy}).  The \astropkg 
...
\begin{enumerate}
   ...
   \item It is also possible to create an arbitrarily complex custom model baed on the \texttt{Model} class.
\end{enumerate}
