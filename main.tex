...
summer. These students ofter turn into long-term contributors. We also
thank NumFOCUS and the Python Software Foundation for financial
support for various needs. Within the academic community, we thank
institutions that make it possible that astronomers and programmers on
their staff can contribute (part of) their time to the development of
\astropy projects. Furthermore, the \astropy packages would not exisit
in their current form without a number of webservices for code
...
Read the Docs.  \astropypkg integrates with the SIMBAD database,
