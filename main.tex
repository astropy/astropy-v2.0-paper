...
%
\inlinecomment{Tom R}{Python calls itself a programming language or general-purpose language, not specifically scripting language. I would remove 'scripting' below.}
\inlinecomment{Perry G}{Yes, it's time to drop the scripting adjective; it's far more general than that now.}
...
respective pull request.\footnote{\url{https://github.com/astropy/astropy-APEs}} \inlinecomment{Tom R}{first mention of a pull request in the context of an APE - need to make it clear that APEs are proposed by PRs}
