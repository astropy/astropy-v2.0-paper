...
\astropy is available from several of the Python distributions for scientific
computing, such as Anaconda or Enthought Canopy, which include also some of
\astropy's affiliated packages.
Alternatively, \astropy can be readily installed from the Python Package Index
...
For most recent \astropy releases, pre-built wheel distributions are obtainable
for Windows, Mac OS X and Linux systems from PyPI that provide faster
