...
\begin{description}\itemsep0ex
    ...
    the \texttt{Representation} classes through the new \texttt{Differential}
    classes.
    The \texttt{Differential} classes are currently used internal to the
    \texttt{Frame} classes to store velocity data when attached to a
    \texttt{Representation} instance.

    TODO: differential classes. Represent single-derivatives of
    ...
    TODO: Frame classes support proper motions, radial velocities. Explain
    component naming, why SkyCoord doesn't support right now, "experimental" but
    tested feature.

    \item[JPL ephemeris]
    TODO: JPL ephemerids % Who can write this? Erik?
\end{description}
