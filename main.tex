...
\section{Notes and guidelines (to be removed)}

\begin{itemize}
	\item Right now, we don't foresee needing to include code in this paper. But, if you think you will need to include code in your section, please add it to a separate Python module (.py file) and include it in this repository. 
\end{itemize}
